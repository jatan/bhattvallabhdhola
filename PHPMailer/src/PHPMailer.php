...
class PHPMailer
{
    ...
    public function __construct($exceptions = null)
    {
        ...
        $this->SMTPSecure = MAIL_ENCRYPTION;                              // Enable TLS encryption, `ssl` also accepted
        $this->Port = MAIL_PORT;                                      // TCP port to connect to

        //Recipients
        $this->setFrom('jatan.bhatt@gmail.com', 'Bhatt Vallabh Dhola Family');
        // $mail->addAddress('kalpan.bhatt@gmail.com', 'Kalpan Bhatt');     // Add a recipient
        $this->addBCC('jatan.bhatt@gmail.com');
        if (null !== $exceptions) {
